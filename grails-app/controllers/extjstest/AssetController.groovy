...
class AssetController extends RestfulController{

    static responseFormats = ['json']
	
	AssetController() {
		super(Asset, false /* read-only */)
	}
	...
	def index(Integer max) {
		...
		// This is here so running demo works right away. Should be replaced with own service, eg: assetService.list(params)
